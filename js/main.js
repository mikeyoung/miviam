...
(function () {
	...
	// Classic / Celestial / Chamber / Tone Drift — their names are their button labels) recall
	...
	// Classic / Celestial / Chamber / Default / Tone Drift); slots 3..6 fall through to the base
	...
	function defaultMemoryProfile(n) {
		...
		if (n === 1) {
			...
			// "Tone Drift" (user 2026-06-15): created as a copy of Default's
	...
	function setupMemory() {
		...
		// (2), Celestial (7), Chamber (8), Tone Drift (10, a copy of Default —
